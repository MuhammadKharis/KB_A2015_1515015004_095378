...
CLAUSES
yang_ulang_tahun_bulan_ini:- %variable declarasi dari sintax ini%
...
daftar_telepon(orang(sri,sugiarti),"014-104",tanggal_lahir(24,mar,1998)).
daftar_telepon(orang(aldi,badwin),"005-109",tanggal_lahir(29,mar,1991)).
daftar_telepon(orang(gigi,gilang),"090-209",tanggal_lahir(09,mar,1990)).
daftar_telepon(orang(titi,coklat),"89-098",tanggal_lahir(01,mar,1980)).
...
%Pertama goal tersebut hanya memunculkan si (kusdiar,prihatin) karena program ini memilih bulan maret.%
%Yang kedua saya disini menambahkan si (sri,sugiarti),(aldi,badwin),(gigi,gilang),(titi,coklat)dalam soal ini untuk memunculkan ini semua%